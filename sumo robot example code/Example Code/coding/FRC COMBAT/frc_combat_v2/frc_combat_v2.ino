...
void ForwardRight (int f_right)
{
  Move(0,f_right,f_right,0);
}

void ForwardLeft (int f_left)
{
  Move(f_left,0,0,f_left);
}

void BackwardRight (int b_right)
{
  Move(b_right,0,0,b_right);
}

void BackwardLeft (int b_left)
{
  Move(0,b_left,b_left,0);
}
...
//------------------ To Control Forward and Backward --------------------------
  ...
  //------------------ Combine --------------------------
    else if (RY < ToZero && LX > ToTwoFF){    //forwardRight
     // ForwardRight(OneSpd);
      Move(0,180,255,0);
    }
    else if (RY > ToTwoFF && LX < ToZero){    //backwardLeft
      // ForwardLeft(OneSpd);
      Move(255,0,0,180);
    }  
    else if (RY < ToZero && LX < ToZero){     //forwardLeft
      // BackwardLeft(OneSpd);
      Move(0,255,180,0);
    }
    else if (RY > ToTwoFF && LX > ToTwoFF){   //backwardRight
      // BackwardRight(OneSpd);
      Move(180,0,0,255);
    }
