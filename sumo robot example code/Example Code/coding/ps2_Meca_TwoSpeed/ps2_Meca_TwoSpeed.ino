...
#define PS2_DAT        A0     //blue
#define PS2_CMD        A1     //green
#define PS2_SEL        A2     //yellow (Attention pin)
...
int EFL = 5; //PWM1 pin grey
int FL1 = 4; //DIR1 pin purple

//Assign pins for Motor  
int EFR = 6;  //PWM2 pin black
int FR1 = 7;  //DIR2 pin white  

//MOTOR DRIVER 2 BACK

//Assign pins for Motor 
int EBR = 10;  //PWM2 pin white
int BR1 = 11;  //DIR2 pin black

//Assign pins for Motor  
int EBL = 9;   //PWM1 pin brown
int BL1 = 8;   //DIR1 pin red 
...
{ 
  ...
  pinMode(EFL, OUTPUT);  //PWM1 pin//
  pinMode(FL1, OUTPUT);    //DIR1 pin//
